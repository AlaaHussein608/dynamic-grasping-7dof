...
track_smc_toppra.py
===================
Live MuJoCo demo: adaptive sliding-mode control tracking a TOPP-RA
time-optimal joint trajectory to Q_TARGET_DEMO.

The SMC law and TOPP-RA retiming live in shared.trajectory_control; this
